...
class Shape {
    ...
    rotate(thetaX, thetaY, thetaZ) {
        this.modelMatrix = mat4.rotateX(this.modelMatrix, thetaX)
        this.modelMatrix = mat4.rotateY(this.modelMatrix, thetaY)
        this.modelMatrix = mat4.rotateZ(this.modelMatrix, thetaZ)
    }
